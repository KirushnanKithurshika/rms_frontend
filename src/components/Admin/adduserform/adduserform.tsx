    ...
    return (
        <div className="add-user-form-container">
            ...
            <div className="add-user-form-header">
                <button className="add-user-back-btn" onClick={onClose}>
                ...
                <div className="add-user-form-group role-selector">
                    ...
                    >
                        <span className="selected-role">
                            {roles.find((r) => r.label === role)?.icon} {role}
                        </span>
            ...
            <div className="add-user-form-actions">
                <button className="add-user-create-btn" onClick={handleSubmit}>
                    Create
                </button>
                <button className="add-user-cancel-btn" onClick={onClose}>
                    Cancel
                </button>
            </div>
        </div>
